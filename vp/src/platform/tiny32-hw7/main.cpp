...
public:
	...
	void parse(int argc, char **argv) override {
		...
		assert((mem_end_addr < clint_start_addr || mem_start_addr > GaussianBlurFilter0_end_addr) &&
...
int sc_main(int argc, char **argv) {
	...
	bus.ports[13] = new PortMapping(opt.GaussianBlurFilter1_start_addr, opt.GaussianBlurFilter1_end_addr);
